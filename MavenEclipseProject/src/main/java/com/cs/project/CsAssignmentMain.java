...
import static com.cs.project.domain.vo.EventDto.State.STARTED;
...
import com.cs.project.dao.EventDao;
...
public class CsAssignmentMain implements CommandLineRunner {
    private static Logger log = LoggerFactory.getLogger(CsAssignmentMain.class);
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(CsAssignmentMain.class, args);
        log.info("Finishing application");
    }

    @Autowired
    public CsAssignmentMain(ObjectMapper objectMapper, Connection connection, EventConverter eventConverter) {
