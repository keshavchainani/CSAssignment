...
import com.cs.project.CsAssignmentMain;
...
public class CsAssignmentMainTest {
    ...
    private CsAssignmentMain applicationRunner;
    ...
    public void testRun__ProcessesLogFileAndSavesResultsToDatabase() throws IOException, SQLException {
        ...
        applicationRunner = new CsAssignmentMain(objectMapper, connection, eventConverter);
